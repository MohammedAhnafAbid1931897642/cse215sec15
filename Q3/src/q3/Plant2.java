 ...
 * @author ahnaf
 */
public class Plant2 extends Plant_Analysis{
    
    private double water_temp, water_level, water_pH, water_turbidity, water_DO;
    private boolean plant_status=false;
    ...
    public Plant2(double water_temp, double water_level, double water_pH, double water_turbidity, double water_DO) {
    ...
    public void checkWaterTemp(){
        System.out.println("Water temp OK");
    }
    ...
    public void checkWaterPH(){
        System.out.println("pH level OK");
    }
    
    public void checkWaterTurbidity(){
         System.out.println("Water turbidity LOW");
    ...
    public void printPlantDirectorName(){
         System.out.println("Mr Samuel Attenson");
