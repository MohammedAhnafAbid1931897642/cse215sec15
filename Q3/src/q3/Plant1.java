 ...
 * @author ahnaf
 */
public class Plant1 extends Plant_Analysis{
    ...
    public Plant1(double water_temp, double water_level, double water_pH, double water_turbidity, double water_DO) {
    ...
    public void printPlantDirectorName(){
        System.out.println("Mr John Jackson");
